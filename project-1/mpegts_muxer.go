...
// Based on https://github.com/bluenviron/gortsplib/blob/v4.12.3/examples/client-play-format-h264-mpeg4audio-save-to-disk/main.go
...
func (e *mpegtsMuxer) writeH264(au [][]byte, pts int64) error {
	...
	// encode into MPEG-TS
	return e.w.WriteH264(e.h264Track, pts, dts, false, au)
}
